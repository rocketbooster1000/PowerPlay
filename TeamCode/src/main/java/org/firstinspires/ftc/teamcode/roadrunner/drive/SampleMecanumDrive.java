...
public class SampleMecanumDrive extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(35, 0, 1.25);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(4.8, 0, 0);

    public static double LATERAL_MULTIPLIER = 1.0144265090543650549450549450549;
